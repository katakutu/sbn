...
<script type="text/Javascript">
	...
	function mainValues() {
		var value1 = document.getElementById('frmList').bankname.value.trim();
		var value2 = document.getElementById('frmList').bankid.value.trim();
		...
		parent.PushChild('KODE_BANK', 'Investor', value1, value2);
	}

	function getValue(e1,e2) {
		document.getElementById('frmList').bankname.value = e2;
		document.getElementById('frmList').bankid.value = e1;
		mainValues();
	}
	...
	<body class="container">
		<form id="frmList" method="post">
			<div class="form-wrap" id="form-wrap">
					<div class="dataTable_wrapper table">
                    	<table class="table table-striped table-bordered table-hover" id="ListBank">
		                    <thead>
		                        <tr>
			        				<th><?= $this->lang->line('bankid') ?></th>
			        				<th><?= $this->lang->line('bankname') ?></th>
			        				<th></th>        				
					    		</tr>
							</thead>
		                    <tbody></tbody>
			...
			<input type="hidden" value="" name="bankid" id="bankid" />
    ...
    $(document).ready(function() {
        ...
        $.ajax({
	        type: 'POST',
	        url: '<?=base_url();?>ListKdBank.jsp/show_kode_bank',
	        data: {},
	        dataType: 'JSON',
	        dataSrc: '',
	        beforeSend: function() {
