...
<script type="text/Javascript">
	...
	function mainValues()
	{
		var value1 = document.getElementById('frmList').fundaccountid.value.trim();
		var value2 = document.getElementById('frmList').fundaccountno.value.trim();

		parent.PopupModal('', '', 'hide');
		parent.PushChild('FUND_ACCOUNT', 'Pemesanan', value1, value2);
	}

	function getValue(e1, e2)
	{
		document.getElementById('frmList').fundaccountid.value = e1;
		document.getElementById('frmList').fundaccountno.value = e2;
		mainValues();
	}
		...
		<form id="frmList" method="post">
			<div class="form-wrap" id="form-wrap">
					<div class="dataTable_wrapper table">
                    	<table class="table table-striped table-bordered table-hover" id="ListFundAccount">
		                    <thead>
		                        <tr>
			...
			<input type="hidden" value="" name="fundaccountno" id="fundaccountno" />
			<input type="hidden" value="" name="fundaccountid" id="fundaccountid" />
    ...
    {    
        ...
        $('#ListFundAccount').DataTable(
        {
            ...
            "searching": true,
            "ajax"   : {
                url : "<?=base_url();?>ListFundAccount.jsp/show_fund_account",
                type: "post",
                data: postData
            },
