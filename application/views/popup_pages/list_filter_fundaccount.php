...
<div class="col-xs-12 col-sm-12 col-md-10">
	...
	<div style="padding-left:15px;">
		<table align="center" width="100%" cellpadding="3px" cellspacing="0px" class="table-responsive-topdown" border="0" style="border-collapse: collapse;">
			<tbody>
				<tr>
					<td align="left" width="200px"><?= $this->lang->line('fundaccountid') ?></td>
				...
				<tr>
					<td align="left" width="200px"><?= $this->lang->line('bankid') ?></td>
					<td align="center" width="10px">:</td>
					<td align="left" class="td-responsive"><?= $resultdata['IdBank'] ?></td>
				</tr>
				<tr>
					<td align="left" width="200px"><?= $this->lang->line('bank_name') ?></td>
					<td align="center" width="10px">:</td>
					<td align="left" class="td-responsive"><?= $resultdata['NamaBank'] ?></td>
				</tr>
				<tr>
					<td align="left" width="200px"><?= $this->lang->line('accountno') ?></td>
					<td align="center" width="10px">:</td>
...
<script type="text/javascript">
	function gotoQuery()
	{
		window.location = "<?=base_url()?>Investor.jsp/filter_view_fundaccount";
	}
