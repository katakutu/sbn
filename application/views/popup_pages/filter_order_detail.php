		...
		<table align="center" width="100%" cellpadding="3px" cellspacing="0px" class="table-responsive-topdown" border="0" style="border-collapse: collapse;">
			<tbody>
				<tr>
					...
					<td align="left" class="td-responsive"><?= $Seri ?></td>
				</tr>
				<tr>
					<td align="left" width="200px"><?= $this->lang->line('ordercode') ?></td>
					<td align="center" width="10px">:</td>
					<td align="left" class="td-responsive"><?= $KodePemesanan ?></td>
				</tr>
				<tr>
					<td align="left" width="200px"><?= $this->lang->line('couponrate') ?></td>
					<td align="center" width="10px">:</td>
					<td align="left" class="td-responsive"><?= $TingkatKupon ?></td>
				</tr>
				<tr>
					<td align="left" width="200px"><?= $this->lang->line('billcode') ?></td>
					<td align="center" width="10px">:</td>
					<td align="left" class="td-responsive"><?= $KodeBilling ?></td>
				</tr>
				<tr>
					<td align="left" width="200px"><?= $this->lang->line('couponamount') ?></td>
					<td align="center" width="10px">:</td>
					<td align="left" class="td-responsive"><?= $NominalKupon ?></td>
				</tr>
				<tr>
					<td align="left" width="200px"><?= $this->lang->line('status') ?></td>
					<td align="center" width="10px">:</td>
					<td align="left" class="td-responsive"><?= $Status ?></td>
				</tr>
				<tr>
					<td align="left" width="200px"><?= $this->lang->line('payout') ?></td>
					<td align="center" width="10px">:</td>
					<td align="left" class="td-responsive"><?= $BatasWaktuBerbayar ?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center" width="10px">:</td>
					<td align="left" class="td-responsive"><?= $IdSeri ?></td>
				</tr>
				<tr>
					<td align="left" width="200px"><?= $this->lang->line('amount') ?></td>
					<td align="center" width="10px">:</td>
					<td align="left" class="td-responsive"><?= $Nominal ?></td>
				</tr>
				<tr>
					<td align="left" width="200px"><?= $this->lang->line('idrek') ?></td>
					<td align="center" width="10px">:</td>
					<td align="left" class="td-responsive"><?= $IdRekDana ?></td>
				</tr>
				<tr>
					<td align="left" width="200px"><?= $this->lang->line('idreksb') ?></td>
					<td align="center" width="10px">:</td>
					<td align="left" class="td-responsive"><?= $IdRekSb ?></td>
				</tr>
				<tr>
			</tbody>
		</table>
...
<script type="text/javascript">
	function gotoQuery()
	{
		window.location = "<?=base_url()?>SBNReport.jsp/monitoring";
	}
