...
<body>
	<div class="container">
	  <div class="jumbotron">
	    ...
	    <h3 class="errorresp"><?= $this->lang->line('error_code') ?>&nbsp;IBNK404&nbsp;|&nbsp;<?= $this->lang->line('page_not_found') ?></h3>
			<div class="flatwrap">
				...
				<div class="form-footer">
					<div style="margin: 0 auto; height: 25px; width: 150px; margin-top: 10px;">
						<input type="button" class="btn btn-danger" onclick="document.location='<?= base_url() ?>default'" name="closeButton" value="Close" class="button">
					</div>
				</div>
			</div>			
	  </div>
