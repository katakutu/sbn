...
<script type="text/Javascript">
	...
	function mainValues() {
		...
		parent.PushChild('KODE_KOTA_FRONT', 'Registration', value1, value2);
	}
	...
	<body class="container">
		<form id="frmList" method="post">
			...
			<input type="hidden" value="<?= $province_code ?>" id="province_code" city="province_code" />
		</form>
	</body>
    ...
    $(document).ready(function() {
        ...
        var province = document.getElementById('province_code').value;
        ...
        $('#ListBank').DataTable({
            ...
            "searching": true,
            "ajax"   : {
                url : "<?=base_url();?>Form.jsp/FrontPopup.jsp/show_kode_kota_db",
                type: "post",
                data: postData,
            },
