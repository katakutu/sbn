...
<body oncontextmenu="return false">
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<ol class="breadcrumb">
				<li><?= $this->lang->line('fund account management') ?></a></li>
				<li><?= $this->lang->line('add fund account') ?></li>
			...
			<div class="col-xs-12 col-sm-8 col-md-10">
				...
				<input type="hidden" id="CHALLENGECODE_TOKEN" name="CHALLENGECODE_TOKEN" value="<?= $challengecode_token ?>"></input>
				...
				<input type="hidden" id="ACTIVITY_TYPE" name="ACTIVITY_TYPE" value="1"></input>
				<input type="hidden" id="FUNCTION_ID" name="FUNCTION_ID" value="<?= $fid ?>"></input>
				<input type="hidden" id="FUNCTION" name="FUNCTION" value="<?= $this->lang->line('transfer bri') ?>"></input>
				<input type="hidden" id="INFO1" name="INFO1" value="<?= $debitaccount ?>"></input>
				<input type="hidden" id="INFO2" name="INFO2" value="<?= $creditaccount ?>"></input>
				<input type="hidden" id="INFO3" name="INFO3" value="<?= $amount ?>"></input>
				<input type="hidden" id="INFO4" name="INFO4" value="<?= $currency ?>"></input>
				...
				<table align="center" width="100%" cellpadding="3px" cellspacing="0px" class="table-responsive-topdown" border="0" style="border-collapse: collapse;">
					<tbody>
						...
						<tr>
							...
							<th align="center" width="10px">:</th>
							<th align="left" class="td-responsive"><?= number_format($amount) ?></th>
						</tr>
						<tr>
							<th align="left" width="15px"><i class="fa fa-chevron-right"></i></th>
			...
			<?php if ($applicationid_token) { ?>
			<div>
				<div style="padding-left:15px; font-size: 12px">
				<h4  style="color:#144069"><strong><?= $this->lang->line('token') ?></strong></h4>
				<table cellpadding="3px" cellspacing="0px" class="table-responsive-topdown" border="0" style="border-collapse: collapse;">
					<tbody>
						<tr>
							<th align="left" width="15px"><i class="fa fa-shield"></i></th>
							<th align="left" width="150px"><?= $this->lang->line('applicationid') ?>&nbsp;<?= $this->lang->line('token') ?></th>
							<th align="center" width="10px">:</th>
							<th align="left" class="td-responsive"><?= $applicationid_token ?></th>
						</tr>
						<tr>
							<th align="left" width="15px"><i class="fa fa-qrcode"></i></th>
							<th align="left" width="150px"><?= $this->lang->line('challenge code') ?></th>
							<th align="center" width="10px">:</th>
							<th align="left" class="td-responsive">
								<a id="popoverToken" href="#" onClick="parent.PopupModal('<?=$this->lang->line('token') ?>', 'Token.jsp/token_img', 'show');" data-content="<?= $this->lang->line('click_token') ?>" rel="popover" data-placement="top" data-trigger="hover">
									<?= $challengecode_token ?>
									</i>
								</a>
							</th>
						...
						<tr>
							<th align="left" width="15px"><i class="fa fa-check-square-o"></i></th>
							<th align="left" width="150px"><?= $this->lang->line('token') ?></th>
							<th align="center" width="10px">:</th>
							<th align="left" class="td-responsive">
								<div class="input-group input-group-sm">
								  <input type="text" class="form-control" placeholder="<?= $this->lang->line('token') ?>" aria-describedby="addon-TOKEN" id="TOKEN" name="TOKEN" required="required" />
								</div>				
							</th>
						</tr>
					</tbody>
			...
			<div class="col-xs-12 col-sm-8 col-md-10">
				...
				<a class="btn btn-theme btn-default" title="<?= $this->lang->line('cancel') ?>" value="Cancel" name="cancel" href="<?php echo base_url('TransferBRI.jsp/add'); ?>" >
					<i class="fa fa-arrow-circle-left"></i>
