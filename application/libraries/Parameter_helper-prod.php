...
class Parameter_helper
{
	...
	public $medalion_mdw 	= "http://172.18.45.156:4040/MedalionMiddleware.asmx?wsdl";
	public $brifast_mdw = "http://172.21.20.13:3030/brifastMiddleware.asmx?wsdl";
	public $serverid	= "172.18.104.99";
	//public $ip_intranet_sbn = "http://10.242.84.14";
	public $ip_intranet_sbn = "https://10.242.19.160"; //load balancer
	//public $ip_intranet_sbn = "http://10.241.67.8"; //drc
	//public $ip_intranet_sbn = "https://10.241.17.18";
